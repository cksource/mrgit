...
module.exports = {
	get helpMessage() {
		...
		return `
    ${ u( 'Description:' ) }
        Installs packages defined in a configuration file. Packages that are already cloned will be skipped.
	...
	beforeExecute() {
		console.log( chalk.blue( 'Cloning missing packages...' ) );
	},
