...
export default {
	...
	beforeExecute( _1, _2, task ) {
		task.output = chalk.blue( 'Collecting changes...' );
	},
	...
	afterExecute( _1, _2, _3, task ) {
		task.output = chalk.blue.italic( 'Logs are displayed from repositories which contain any change.' );
	}
};
